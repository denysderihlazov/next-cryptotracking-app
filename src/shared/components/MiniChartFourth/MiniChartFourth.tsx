...
import { MiniChartFourthProps } from "./MiniChartFourth.props";
import styles from "./MiniChartFourth.module.css";
...
export const MiniChartFourth = (props) => {
        ...
        datasets: [
            {
                ...
                borderColor: (context: ScriptableContext<"line">) => {
                    ...
                    gradient.addColorStop(0, "rgba(185,237,65,255)");
                    gradient.addColorStop(1, "rgba(73,230,142,255)");
                    return gradient;
                },
    ...
    return (
        <div
            ...
            {...props}
        >
            <div className={styles.info}><P size="s">BTC <FaExchangeAlt />USDT</P>  <P>{((parseFloat(coinPrice[coinPrice.length -1]) - (parseFloat(coinPrice[0]))) / (parseFloat(coinPrice[0]))*100).toFixed(2)}%</P></div>
